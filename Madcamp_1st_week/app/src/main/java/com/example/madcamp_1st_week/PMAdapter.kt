...
class PMAdapter (private val context: Context): RecyclerView.Adapter<PMAdapter.PagerViewHolder>(){

    var pms = mutableListOf<FriendItem>()
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PMAdapter.PagerViewHolder {
//        val view = LayoutInflater.from(context).inflate(R.layout.item_recyclerview,parent,false)
        val view = LayoutInflater.from(context).inflate(R.layout.contact_item,parent,false)
        return PagerViewHolder(view)
    }

    override fun getItemCount(): Int = pms.size
